...
Menu.create(dish_id: dish1.id, ingredient_id: ingredient1.id)
Menu.create(dish_id: dish1.id, ingredient_id: ingredient2.id)
Menu.create(dish_id: dish1.id, ingredient_id: ingredient3.id)

Menu.create(dish_id: dish2.id, ingredient_id: ingredient3.id)
Menu.create(dish_id: dish2.id, ingredient_id: ingredient4.id)